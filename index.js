                             ...
                             if (name === "create_post") {
                                         ...
                                         return {
                                                         content: [
                                                             {
                                                                                     type: "text",
                                                                                     text: "La funcionalidad de obtener experiencia laboral requiere permisos adicionales de la API de LinkedIn (r_fullprofile). Por favor, comparte tu experiencia laboral manualmente.",
                                                             }
                                                                         ]
                                         };
                             }
